...
public interface ITaskService
{
    ...
    Task<TaskCreateResult?> CreateTaskAsync(string title, string priority = "medium", DateTime? dueDate = null, CancellationToken cancellationToken = default);
    Task<bool> UpdateStatusAsync(string taskId, string status, CancellationToken cancellationToken = default);
    Task<bool> UpdateTaskAsync(string taskId, string title, string priority, DateTime? dueDate = default, CancellationToken cancellationToken = default);
